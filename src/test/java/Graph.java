...
public class Graph extends HttpServlet {
	...
	request.getRequestDispatcher("Graph1.jsp").forward(request, response);
		...
		/*HttpServletRequest r = (HttpServletRequest) request.getAttribute("project");
		
		System.out.println(r);*/
		
		/*ArrayList<MyWSDLModel> c = (ArrayList<MyWSDLModel>) request.getSession().getAttribute("players");
		...
		project = 
		(List<MyWSDLModel>) context.getAttribute("project");
